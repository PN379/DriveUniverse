...
**One place for everything you need to manage your external drives.**

Safely eject, reconnect, and manage your drives in one place with a floating desktop widget and system tray app. Automate routine actions, launch your preferred disk utilities instantly, and optionally control everything hands-free using fully offline voice commands powered by Windows’ built-in Speech API (SAPI5).
